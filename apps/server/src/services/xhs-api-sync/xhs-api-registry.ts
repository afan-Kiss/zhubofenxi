...
export const XHS_API_REGISTRY: Record<XhsApiKey, XhsApiDefinition> = {
  ...
  live_replay_transform: {
    key: 'live_replay_transform',
    name: '直播回放转化漏斗',
    method: 'POST',
    url: 'https://ark.xiaohongshu.com/api/edith/live/replay/pv/transform',
    referer: 'https://ark.xiaohongshu.com/live_review',
    enabled: true,
    needSign: true,
    pageMode: 'none',
    pageSize: 1,
  ...
  live_replay_note: {
    key: 'live_replay_note',
    name: '直播回放笔记引流',
    method: 'POST',
    url: 'https://ark.xiaohongshu.com/api/edith/live/replay/pv/note',
    referer: 'https://ark.xiaohongshu.com/live_review',
    enabled: true,
    needSign: true,
    pageMode: 'page_no',

...
export const BossShopRankCards: React.FC<Props> = ({ shops, selectedShopKey, onSelect }) => {
  return (
    <section className="space-y-3">
      <h3 className="text-sm font-semibold text-slate-900">店铺资金状态</h3>
        ...
        {shops.map((shop) => {
          ...
          return (
            <button
              ...
              className={`min-w-0 rounded-2xl border bg-white p-4 text-left shadow-sm transition hover:shadow-md border-slate-100 ${
